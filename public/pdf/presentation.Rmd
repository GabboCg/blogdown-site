...
Como ya saben existe la librería plotly la que nos permite construir gráficos dinamicos. A continuación les presentó lo útil que es para realizar análisis técnico:
...
\begin{block}{Recomendación}
  ...
  1. \href{https://plotly-book.cpsievert.me}{plotly for R}
