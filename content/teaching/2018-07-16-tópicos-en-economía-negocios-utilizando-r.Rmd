...
3. Tarea 3 
    ...
    a. [Enunciado](/pdf/Enunciado_Tarea3_R_Primavera_2018.pdf)
    b. Pauta
...
Para un mayor detalle del curso recomiendo visitar el website creado utilizando la librería [Radix](https://rstudio.github.io/radix/).

    <div class="btn-group">
    
    <br>
    <button class="button" onclick="myFunction()"> 
    [Radix Website](https://rstudio.github.io/radix/])
    </button>
